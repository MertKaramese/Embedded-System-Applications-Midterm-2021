...
const char* device_name = "Enes";    //Device Name
const char* ssid = "Galatasaray";   //Wi-Fi Name
const char* password = "19051997";    //Wi-Fi Password
const char* mqtt_broker = "broker.hivemq.com";    //MQTT Broker Adress

String subscribe_1 = "BEFESP32/out_20";    //Private messages from Musa
String subscribe_2 = "BEFESP32/out_10";    //Private messages from Umut
String subscribe_3 = "BEFESP32/out_2";     //Messages from Musa
String subscribe_4 = "BEFESP32/out_1";     //Messages from Umut

//To Musa...
String publish_1 = "BEFESP32/out_02";
String message_to_1 = "Musa:";

//To Umut...
String publish_2 = "BEFESP32/out_01";
String message_to_2 = "Umut:";

//To all...
String publish_3 = "BEFESP32/out_0";
