...
const char* device_name = "Umut";    //Device Name
const char* ssid = "NetMASTER Uydunet-15CC";   //Wi-Fi Name
const char* password = "adbda4f8";    //Wi-Fi Password
const char* mqtt_broker = "broker.hivemq.com";    //MQTT Broker Adress

String subscribe_1 = "BEFESP32/out_01";    //Private messages from Enes
String subscribe_2 = "BEFESP32/out_21";    //Private messages from Musa
String subscribe_3 = "BEFESP32/out_0";     //Messages from Enes
String subscribe_4 = "BEFESP32/out_2";     //Messages from Musa

//To Enes...
String publish_1 = "BEFESP32/out_10";
String message_to_1 = "Enes:";

//To Musa...
String publish_2 = "BEFESP32/out_12";
String message_to_2 = "Musa:";

//To all...
String publish_3 = "BEFESP32/out_1";
